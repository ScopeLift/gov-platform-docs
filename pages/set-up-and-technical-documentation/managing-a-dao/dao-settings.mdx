...
From the **Admins** tab, view your organization's [Admins and Superadmins](/set-up-and-technical-documentation/managing-a-dao/dao-admins). If you have the Superadmin role, you can also add these roles for other wallet addresses.
