...
* The [auto-delegate](/set-up-and-technical-documentation/staking-contracts/how-staking-works/liquid-staking/lst-auto-delegates) can be configured by governance. This keeps the default voting power aligned with the organization and mitigates capture risk.
...
![Roles and key methods of the LST](/images/image-1.png)
