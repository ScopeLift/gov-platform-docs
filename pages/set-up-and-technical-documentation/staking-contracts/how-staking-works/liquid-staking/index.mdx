...
* The [auto-delegate](lst-auto-delegates) can be configured by governance. This keeps the default voting power aligned with the organization and mitigates capture risk.
...
<figure><img src="/images/image-1.png" alt="" /><figcaption><p>Roles and key methods of the LST</p></figcaption></figure>
