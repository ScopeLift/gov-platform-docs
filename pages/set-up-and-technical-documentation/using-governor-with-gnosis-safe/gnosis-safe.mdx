...
> _It's easy to create or link a Gnosis Safe on Tally from_ [dao-settings.md](../managing-a-dao/dao-settings.md "mention")_. Learn more about Gnosis Safes below, or skip right to the_ [_step-by-step instructions_](gnosis-safe#tally)_._
...
<figure><img src="/images/cleanshot-2023-02-22-at-20-33-18-2x.png" alt="" /><figcaption><p>Gnosis Safes tab in <a data-mention href="../managing-a-dao/dao-settings.md">dao-settings.md</a>.</p></figcaption></figure>
...
<figure><img src="/images/cleanshot-2023-02-22-at-20-40-12-2x.png" alt="" /><figcaption><p>Create a Gnosis Safe.</p></figcaption></figure>

Select the Safe's network, give it a name, add [Safe owners](gnosis-safe#owner) and set its [threshold](gnosis-safe#threshold). Then click the **Create Safe** button!
...
<figure><img src="/images/cleanshot-2023-02-22-at-20-35-55-2x.png" alt="" /><figcaption><p>Link a Gnosis Safe.</p></figcaption></figure>
