...
Tally's staking system integrates with [Delegate Reputation Score (DRS)](../governance/delegate-reputation-score-drs) tracking to measure and reward quality governance participation.
...
Customer example: [Obol](https://docs.obol.org/community-and-governance/governance/delegate-guide/delegate-reputation-score-and-compensation) uses DRS integration to gate delegate compensation, ensuring only active, engaged delegates receive staking rewards.
