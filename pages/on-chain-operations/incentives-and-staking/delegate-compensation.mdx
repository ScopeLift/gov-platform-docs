---
description: Reward active governance participants for their time
---
...
Obol uses Tally's infrastructure to reward governance participants based on [Delegate Reputation Score (DRS)](../governance/delegate-reputation-score-drs).
