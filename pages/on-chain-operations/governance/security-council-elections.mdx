...
![Cohort 1 of Arbitrum DAO's Security Council is made up of 12 members; subsequent cohorts will have 6 members.](/images/image-124.png)
...
![In this example, the vote threshold to qualify for Round 2 is 4.7M. Matt Fiebach has met the vote threshold and will move on to Round 2, while Matt StableLab will not pass Round 1.](/images/image-125.png)
...
![The homepage of Arbitrum DAO's Security Council Elections](/images/image-126.png)

![The voting slate for Arbitrum DAO's first Security Council Election](/images/image-127.png)
