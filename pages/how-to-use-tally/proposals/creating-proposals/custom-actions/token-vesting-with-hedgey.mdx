...
2.  Create a second custom action with the following.
    ...
    * **Contract method:** batchVestingPlans
    ...
    <figure><img src="/images/screenshot-2023-11-06-at-3-51-46-pm.png" alt="" /><figcaption></figcaption></figure>
...
<figure><img src="/images/telegram-cloud-photo-size-1-5136552046319742074-y.jpg" alt="" /><figcaption><p>These calldatas are just examples; you will need to choose your own according to your DAO's plans.</p></figcaption></figure>
