...
1.  The first custom action is to approve the allowance for the Hedgey contract to spend the tokens to create vesting plans.
    ...
    * **Calldatas:**
    ...
    ![](https://lh7-us.googleusercontent.com/iMXSi_WU6FwGdzBUyktACIhr4wmZFqHdCpNeOy08L2_6_xFvy-HToiit8cx6A_6SQDh49-Y3_fDzmncQmfAwkyR_vr1qEnHlzqHGBX-bdg4idp-PnWTMMrzgVTqhJgm2gcGUQcxO3ANVzcDpL6cDr94)
2.  Create a second custom action with the following.
    ...
    * **Contract method:** batchVestingPlans
    ...
    ![](/images/screenshot-2023-11-06-at-3-51-46-pm.png)
...
![These calldatas are just examples; you will need to choose your own according to your DAO's plans.](/images/telegram-cloud-photo-size-1-5136552046319742074-y.jpg)
